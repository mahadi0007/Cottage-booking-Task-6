...
public class BookingSuggestionResponse {
	...
	public BookingSuggestionResponse(String bookerName, String bookingNumber, String cottageAddress,
			...
			int distanceToCity, String bookingStartDate, String bookingEndDate, String isAvailableFrom) {
	...
	public BookingSuggestionResponse(Map<String, String> data) {
		...
		this.cottageImageUrl = data.getOrDefault("imgUrl", null);
		...
		this.isAvailableFrom = data.getOrDefault("availableFrom", null);
		
		System.out.println("9---data---99" + data);
	}
